  ...
  return Object.keys(endpoints).reduce(function (acc, key) {
    ...
    acc[key] = function () {
      ...
      var promise = req.then(function (result) {
        return afterResolve(_extends({}, result, { endpoint: key, path: path, placeholders: placeholders }));
        ...
        return afterReject(_extends({}, result, { endpoint: key, path: path, placeholders: placeholders }));
      });
